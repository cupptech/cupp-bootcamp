...
module.exports = function () {
    ...
    this.union = function(otherSet, newSet){
        var unionSet = newSet; //{1}
    ...
    this.intersection = function(otherSet, newSet){
        var intersectionSet = newSet; //{1}
    ...
    this.difference = function(otherSet, newSet){
        var differenceSet = newSet; //{1}
